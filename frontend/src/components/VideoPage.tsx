        ...
        <div>
          ...
          <div className="mt-4">
            ...
            <div className="mt-4 p-4 bg-gray-100 rounded-lg">
              <p className="text-sm font-medium text-gray-700 mb-3">{video.Views.toLocaleString()} views • Uploaded {new Date(video.CreatedAt).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' })}</p>
              <p className="text-base whitespace-pre-wrap">{video.Description}</p>
            </div>
            {video.Summary && (
              <div className="mt-4 p-4 bg-gray-100 rounded-lg">
                <h2 className="text-base font-bold mb-2">Summary generated by {video.SummaryModel}</h2>
